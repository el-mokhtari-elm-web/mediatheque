  ...
  <nav id="nav-height" class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top py-3">
    <div class="container">
          ...
          <div class="d-flex flex-row justify-content-center align-items-center collapse navbar-collapse all-navs" id="navbarResponsive">
            <ul class="navbar-nav ml-auto text-center nav-principal">
                ...
                <li class="nav-item <?php if ($_SERVER["REQUEST_URI"] === BOOKING) { echo 'active'; } ?>">
                    <a class="nav-link" href="<?php echo BOOKING; ?>">médiathèque</a>
                </li>
            ...
            <!--<ul class="navbar-nav ml-auto pl-5 nav-login-connex">-->
            <ul class="navbar-nav ml-auto text-center nav-principal">
                ...
                <li class="nav-item btn-logout">
                  <form class="nav-link" method="post" name="logout"><input type="hidden" name="hidden"><input type="submit" name="logout" value=""></form>
                </li>
