...
<div class="container">
    <div class="main-body">
              ...
              <div class="row gutters-sm my-5">
                  ...
                  <div class="col-md-8 mb-5 pb-5 position-relative">
                      <h3 class="text-info my-0">Liste des utilisateurs</h3>
                          ...
                          <tbody>
                            ...
                            ?>
                              ...
                              <tr class="row-user">
                                ...
                                <td><?php echo $dbConnect->dateToFrench($user['registration_date'], 'd F Y'); ?></td>

                                <td><?php if (isset($user['termination_date'])) {echo $dbConnect->dateToFrench($user['termination_date'], 'd F Y');} ?></td>
                          ...
                          <div class="col-sm-12 mb-3">
                            <div class="card h-100">
                              <div class="card-body">
                                ...
                                <li class="d-flex align-items-center small mb-1"><span class="d-block small text-success text-right px-3">Nombre total d'utilisateurs :</span><?php echo count($users); ?></li>
                                ...
                                <li class="d-flex align-items-center small mb-1"><span class="d-block small text-success text-right px-3">Nombre total de livres :</span><?php echo count($books); ?></li>
                                <li class="d-flex align-items-center small mb-1"><span class="d-block small text-success text-right px-3">Nombre total de livres sortis :</span><?php echo $booksNotAvailable[0]['books_not_available']; ?></li>
                              </div>
                            </div>
                          </div>
                      </div>
